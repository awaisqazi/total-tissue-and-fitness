...
- [x] Gift Cards added to the Vagaro widget alongside Services and Book Now; About and Staff remain as secondary links, with a direct Vagaro fallback (ADR-012).
